...
let test_my_scanr ctxt =
  assert_equal [0] (my_scanr (+) [] 0) ~msg: "my_scanr (1)" ~printer:string_of_int_list;
  assert_equal [6; 5; 3; 0] (my_scanr (+) [1; 2; 3] 0) ~msg: "my_scanr (2)" ~printer:string_of_int_list;
  assert_equal ["ab!"; "b!"; "!"] (my_scanr (^) ["a"; "b"] "!") ~msg: "my_scanr (3)" ~printer:string_of_string_list
